...
import (
	...
	externalversions "github.com/pramodbindal/my-custom-labeler/pkg/client/informers/externalversions"
	client "github.com/pramodbindal/my-custom-labeler/pkg/client/injection/client"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/pramodbindal/my-custom-labeler/pkg/client/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
